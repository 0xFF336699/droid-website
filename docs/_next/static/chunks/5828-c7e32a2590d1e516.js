"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5828],{
...
class IFrameContainer {
    ...
    fitIframe() {
        ...
        console.log("this.initializeResultList=", this.initializeResultList);
    }
   ...
   */ setMaxSize(maxWidth, maxHeight) {
    ...
    handleIframeMessage(event) {
        ...
        console.log("event.data.iframeId=", event.data.iframeId);
        console.log("this.iframeId=", this.iframeId);
        console.log("this.resizeEnabled=", this.resizeEnabled);
        console.log("this.originalState.isFullscreen=", this.originalState.isFullscreen);
