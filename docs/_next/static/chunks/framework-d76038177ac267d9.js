...
if (true) {
  module.exports = __webpack_require__(56354);
} else {}
...
if (true) {
    ...
    checkDCE();
    module.exports = __webpack_require__(64680);
} else {}
...
if (true) {
  module.exports = __webpack_require__(42152);
} else {}
...
*/ 
var Scheduler = __webpack_require__(3625), React = __webpack_require__(91844), ReactDOM = __webpack_require__(75814);
function formatProdErrorMessage(code) {
    var url = "https://react.dev/errors/" + code;
    if (1 < arguments.length) {
        url += "?args[]=" + encodeURIComponent(arguments[1]);
...
if (true) {
    ...
    // DevTools can report bad minification during injection.
    checkDCE();
    module.exports = __webpack_require__(62622);
} else {}
...
if (true) {
  module.exports = __webpack_require__(98867);
} else {}
...
//# sourceMappingURL=framework-d76038177ac267d9.js.map